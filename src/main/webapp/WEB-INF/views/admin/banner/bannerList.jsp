		...
		<table>
			<tr>
				<td width="750" align="right">
					<input class="btn" type="button" name="btn_write" value="새 배너 등록"
				...
				<c:otherwise>
					<c:forEach items="${bannerList}" var="bannerVO">
						<tr>
							...
							<td>
								<select name="order_seq" onChange="change_order('${bannerVO.BSEQ}');">
							...
							<td><fmt:formatDate value="${bannerVO.INDATE}" /></td>
							<td>
								<input type="button" value="수정"
									onClick="location.href='editBanner?bseq=${bannerVO.BSEQ}'">
							</td>
						</tr>
					</c:forEach>
				</c:otherwise>
